...
Future<RSA?> loadRequestFromDB(String id, String requestType) async {
  ...
  RSA rsa = RSA(
    user: _user, // MUST
    car: car,// MUST
    state: RSA.stringToState(dataSnapshot.child("state").value.toString()), // MUST
    rsaID: dataSnapshot.key.toString(), // MUST
    requestType: t, // MUST
    location: CustomLocation( // MUST
      name: "Location",
    ...
    // report: Report()
    dropOffLocation: dropOffLocationTTA, // OPTIONAL
